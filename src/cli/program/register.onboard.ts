...
export function registerOnboardCommand(program: Command) {
  program
    ...
    .option("--tabcode-api-key <key>", "Tabcode API key")
    .option("--gmn-api-key <key>", "GMN API key")
        ...
        await onboardCommand(
          {
            ...
            tabcodeApiKey: opts.tabcodeApiKey as string | undefined,
            gmnApiKey: opts.gmnApiKey as string | undefined,
