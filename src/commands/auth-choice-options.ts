...
const AUTH_CHOICE_GROUP_DEFS: {
  ...
  },
  {
    value: "tabcode",
    label: "Tabcode",
    hint: "Anthropic Messages (GLM)",
    choices: ["tabcode-api-key"],
  },
  {
    value: "gmn",
    label: "GMN",
    hint: "OpenAI Responses (Codex gateway)",
    choices: ["gmn-api-key"],
  },
  {
    value: "together",
...
export function buildAuthChoiceOptions(params: {
  ...
  options.push({
    value: "tabcode-api-key",
    label: "Tabcode API key",
    hint: "Anthropic Messages gateway (glm-4.7)",
  });
  options.push({
    value: "gmn-api-key",
    label: "GMN API key",
    hint: "OpenAI-compatible gateway (gpt-5.3-codex)",
  });
  options.push({
